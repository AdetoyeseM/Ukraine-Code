...
class PlayerWidgetMy extends StatefulWidget {
  final String url;
  ...
  State<StatefulWidget> createState() {
    return _PlayerWidgetMyState(url, mode);
  }
}

class _PlayerWidgetMyState extends State<PlayerWidgetMy> {
  String url;
  PlayerMode mode;
  ...
  _PlayerWidgetMyState(this.url, this.mode);
